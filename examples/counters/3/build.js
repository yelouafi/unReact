...
},{"../../../src/app":11,"snabbdom/h":3}],2:[function(require,module,exports){
'use strict';
...
var app = new _srcApp.App(),
  ...
  return counters(-1).concat((0, _counter2['default'])(reset$));
}), app.on('remove').map(function (_) {
  return counters(-1).slice(1);
}));

app.view = function () {
  return (0, _snabbdomH2['default'])('div.main', [(0, _snabbdomH2['default'])('button', { on: { click: app.publish('reset') } }, 'RESET'), (0, _snabbdomH2['default'])('button', { on: { click: app.publish('add') } }, 'Add'), (0, _snabbdomH2['default'])('button', { on: { click: app.publish('remove') } }, 'Remove'), (0, _snabbdomH2['default'])('div', counters().map(function (c) {
    return c.view();
  }))]);
};
