...
app.view = function () {
  return (0, _snabbdomH2['default'])('div', [(0, _snabbdomH2['default'])('button', { on: { click: app.publish('reset$') } }, 'RESET'), (0, _snabbdomH2['default'])('button', { on: { click: app.publish('add$') } }, 'Add'), (0, _snabbdomH2['default'])('button', { on: { click: app.publish('remove$') } }, 'Remove'), (0, _snabbdomH2['default'])('div', counters().map(function (c) {
    return c.view();
  }))]);
};
