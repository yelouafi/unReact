...
var app = new _srcApp.App(),
    reset$ = app.on('reset'),
    topCounter = (0, _counter2['default'])(reset$),
    bottomCounter = (0, _counter2['default'])(reset$);

app.view = function () {
  return (0, _snabbdomH2['default'])('div.main', [topCounter.view(), bottomCounter.view(), (0, _snabbdomH2['default'])('button', { on: { click: app.publish('reset') } }, 'RESET')]);
};
