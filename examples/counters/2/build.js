...
var app = new _srcApp2['default'](),
    reset$ = app.on('reset$'),
    topCounter = (0, _counter2['default'])(app, reset$),
    bottomCounter = (0, _counter2['default'])(app, reset$);

app.view = function () {
  return (0, _snabbdomH2['default'])('div', [topCounter.view(), bottomCounter.view(), (0, _snabbdomH2['default'])('button', { on: { click: app.publish('reset$') } }, 'RESET')]);
};
