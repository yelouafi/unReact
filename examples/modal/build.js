...
app.view = function () {
  return (0, _snabbdomH2['default'])('div', ['Press the button below to open the modal', (0, _snabbdomH2['default'])('br'), (0, _snabbdomH2['default'])('button', { on: { click: app.publish('open$') } }, 'Open modal'), isModalOpen() ? myModal.view(['This is inside the modal', (0, _snabbdomH2['default'])('br'), 'The modal is attached to the body', (0, _snabbdomH2['default'])('br'), (0, _snabbdomH2['default'])('button', { on: { click: app.publish('close$') } }, 'Close')]) : (0, _snabbdomH2['default'])('span')]);
};
...
},{"../../src/app":12,"./modal":2,"snabbdom/h":3}],2:[function(require,module,exports){
'use strict';
...
var _snabbdomHelpersAttachto = require('snabbdom/helpers/attachto');
...
},{"../../src/app":12,"snabbdom/h":3,"snabbdom/helpers/attachto":4}],3:[function(require,module,exports){
...
},{"./base":13,"./event":14,"./subscription":15,"snabbdom":10,"snabbdom/h":3,"snabbdom/modules/class":6,"snabbdom/modules/eventlisteners":7,"snabbdom/modules/props":8,"snabbdom/modules/style":9}],13:[function(require,module,exports){
'use strict';
