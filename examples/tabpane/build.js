...
function counter() {
  ...
  app.view = function () {
    return (0, _snabbdomH2['default'])('div.counter', { style: countStyle }, [(0, _snabbdomH2['default'])('button', { on: { click: app.publish('dec') } }, '–'), (0, _snabbdomH2['default'])('div', { style: countStyle }, counter()), (0, _snabbdomH2['default'])('button', { on: { click: app.publish('inc') } }, '+')]);
  };
...
},{"../../src/app":12,"snabbdom/h":4}],2:[function(require,module,exports){
'use strict';
...
var myTabs = (0, _tabs2['default'])({
  Counter1: (0, _counter2['default'])(),
  Counter2: (0, _counter2['default'])()
});
...
},{"../../src/app":12,"./counter":1,"./tabs":3,"snabbdom/h":4}],3:[function(require,module,exports){
'use strict';
...
function tabs(panes) {
  ...
  var selected = (0, _srcApp.step)(titles[0], app.on('select'));
...
},{"../../src/app":12,"snabbdom/h":4}],4:[function(require,module,exports){
