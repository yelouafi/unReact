...
function counter() {
  ...
  app.view = function () {
    return (0, _snabbdomH2['default'])('div', { style: countStyle }, [(0, _snabbdomH2['default'])('button', { on: { click: app.publish('dec$') } }, '–'), (0, _snabbdomH2['default'])('div', { style: countStyle }, counter()), (0, _snabbdomH2['default'])('button', { on: { click: app.publish('inc$') } }, '+')]);
  };
...
},{"../../src/app":13,"snabbdom/h":5}],2:[function(require,module,exports){
'use strict';
...
var myTabs = (0, _tabs2['default'])({
  ...
  Switcher: (0, _switcher2['default'])()
});

app.view = function () {
  return (0, _snabbdomH2['default'])('div', [(0, _snabbdomH2['default'])('h1', 'Tabs'), myTabs.view()]);
};
...
},{"../../src/app":13,"./counter":1,"./switcher":3,"./tabs":4,"snabbdom/h":5}],3:[function(require,module,exports){
'use strict';
...
function switcher() {
  ...
  app.view = function () {
    return (0, _snabbdomH2['default'])('div.switch', { on: { click: app.publish('toggle$') } }, [(0, _snabbdomH2['default'])('span', { 'class': { active: model() === 0 } }, 'On'), (0, _snabbdomH2['default'])('span', { 'class': { active: model() === 1 } }, 'Off')]);
  };
...
},{"../../src/app":13,"snabbdom/h":5}],4:[function(require,module,exports){
'use strict';
...
function tabs(panes) {
  ...
  var app = new _srcApp2['default']();
  var titles = Object.keys(panes);
  var selected = app.scanB(function (_, title) {
    return title;
  }, titles[0], app.on('select$'));

  app.view = function () {
    return (0, _snabbdomH2['default'])('div', [(0, _snabbdomH2['default'])('ul.nav.nav-tabs', titles.map(function (title) {
      return (0, _snabbdomH2['default'])('li', { 'class': { active: selected() === title } }, [(0, _snabbdomH2['default'])('a', { props: { href: '#' }, on: { click: app.publish('select$', title) } }, title)]);
    })), (0, _snabbdomH2['default'])('div.tab-content', [(0, _snabbdomH2['default'])('div.tab-pane.active', [panes[selected()].view()])])]);
  };
...
},{"../../src/app":13,"snabbdom/h":5}],5:[function(require,module,exports){
...
},{"./base":14,"./event":15,"./subscription":16,"snabbdom":11,"snabbdom/h":5,"snabbdom/modules/class":7,"snabbdom/modules/eventlisteners":8,"snabbdom/modules/props":9,"snabbdom/modules/style":10}],14:[function(require,module,exports){
'use strict';
