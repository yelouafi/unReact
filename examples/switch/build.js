...
var app = new _srcApp2['default'](),
    views = [app.scanB(function (acc) {
  return acc + 1;
}, 0, app.on('click$')).keepAlive(), app.constB('Hello there')],
    idx = app.scanB(function (n) {
  return 1 - n;
}, 0, app.on('switch$'));

app.view = function () {
  return (0, _snabbdomH2['default'])('div', {}, [(0, _snabbdomH2['default'])('button', { on: { click: app.publish('switch$') } }, 'Switch'), (0, _snabbdomH2['default'])('button', { on: { click: app.publish('click$') } }, 'Counter'), (0, _snabbdomH2['default'])('div', [views[idx()]()])]);
};
...
var App = (function () {
  ...
  _createClass(App, [{
    ...
    key: 'updatedEagerBehs',
    value: function updatedEagerBehs() {
      var behs = this.eagerBehs;
      for (var i = 0, len = behs.length; i < len; i++) {
        behs[i]();
      }
      if (this.parent instanceof App) this.parent.updatedEagerBehs();
    }
  }, {
    key: 'view',
    value: function view() {
